...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1753scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        Executor executor = getExecutor();
        ...
        if (scheduledFutureScheduleBlock != null) {
            ...
            DefaultExecutor.INSTANCE.mo1753scheduleResumeAfterDelay(timeMillis, continuation);
        }
    }
