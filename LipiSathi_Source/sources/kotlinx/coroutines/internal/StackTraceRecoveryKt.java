...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM200constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM200constructorimpl = Result.m200constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM200constructorimpl = Result.m200constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m203exceptionOrNullimpl(objM200constructorimpl) == null) {
            obj2 = objM200constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM200constructorimpl2 = Result.m200constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM200constructorimpl2 = Result.m200constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m203exceptionOrNullimpl(objM200constructorimpl2) == null) {
            obj = objM200constructorimpl2;
        }
    ...
    private static final <E extends Throwable> Pair<E, StackTraceElement[]> causeAndStacktrace(E e) {
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            for (StackTraceElement stackTraceElement : currentTrace) {
