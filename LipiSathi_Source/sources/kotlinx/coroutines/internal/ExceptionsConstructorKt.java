...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM200constructorimpl = Result.m200constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM200constructorimpl;
        }
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        try {
                            ...
                            it.initCause(e);
                            objM200constructorimpl = Result.m200constructorimpl(it);
                            if (Result.m206isFailureimpl(objM200constructorimpl)) {
                                objM200constructorimpl = null;
                            }
                            return (Throwable) objM200constructorimpl;
                        } catch (Throwable th) {
                            Result.Companion companion2 = Result.INSTANCE;
                            objM200constructorimpl = Result.m200constructorimpl(ResultKt.createFailure(th));
                        }
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        try {
                            ...
                            objM200constructorimpl = Result.m200constructorimpl((Throwable) objNewInstance);
                            if (Result.m206isFailureimpl(objM200constructorimpl)) {
                                objM200constructorimpl = null;
                            }
                            return (Throwable) objM200constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM200constructorimpl = Result.m200constructorimpl(function2.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM200constructorimpl = Result.m200constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM200constructorimpl = Result.m200constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM200constructorimpl = Result.m200constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m206isFailureimpl(objM200constructorimpl)) {
            objM200constructorimpl = numValueOf;
        }
        return ((Number) objM200constructorimpl).intValue();
    }
