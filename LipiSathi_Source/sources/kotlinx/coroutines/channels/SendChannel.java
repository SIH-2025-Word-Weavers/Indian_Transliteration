...
public interface SendChannel<E> {
    ...
    Object mo1707trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1707trySendJP2dKIU(e);
            if (ChannelResult.m1722isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1716exceptionOrNullimpl = ChannelResult.m1716exceptionOrNullimpl(result);
