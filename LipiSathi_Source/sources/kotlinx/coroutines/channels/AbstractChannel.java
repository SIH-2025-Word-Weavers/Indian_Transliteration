...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final Object mo1705receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        AbstractChannel$receiveCatching$1 abstractChannel$receiveCatching$2 = abstractChannel$receiveCatching$1;
        Object $result = abstractChannel$receiveCatching$2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (abstractChannel$receiveCatching$2.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                Object result = pollInternal();
                if (result != AbstractChannelKt.POLL_FAILED) {
                    return result instanceof Closed ? ChannelResult.INSTANCE.m1725closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1727successJP2dKIU(result);
                }
                abstractChannel$receiveCatching$2.label = 1;
                objReceiveSuspend = receiveSuspend(1, abstractChannel$receiveCatching$2);
    ...
    public final Object mo1706tryReceivePtdJZtk() {
        Object result = pollInternal();
        if (result == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.INSTANCE.m1726failurePtdJZtk();
        }
        return result instanceof Closed ? ChannelResult.INSTANCE.m1725closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1727successJP2dKIU(result);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1743constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.mo1751remove()) {
                    previous.helpRemove();
                } else {
                    list = InlineList.m1748plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1704onCancelIdempotentListww6eGU(list, closedForSend);
                return;
            }
        }
    }
    ...
    protected void mo1704onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) throws Throwable {
            ...
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1712boximpl(ChannelResult.INSTANCE.m1725closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
        ...
        if (receiveMode != 1) {
            ...
            Object $this$toResult$iv = ChannelResult.m1712boximpl(value instanceof Closed ? ChannelResult.INSTANCE.m1725closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.INSTANCE.m1727successJP2dKIU(value));
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m200constructorimpl(Boxing.boxBoolean(false)));
                        break;
                    }
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m200constructorimpl(ResultKt.createFailure(((Closed) result).getReceiveException())));
                    break;
                }
                if (result != AbstractChannelKt.POLL_FAILED) {
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1712boximpl(ChannelResult.INSTANCE.m1727successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m200constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                ChannelResult channelResultM1712boximpl = ChannelResult.m1712boximpl(ChannelResult.INSTANCE.m1725closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m200constructorimpl(channelResultM1712boximpl));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1712boximpl(ChannelResult.INSTANCE.m1727successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        break;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1712boximpl(ChannelResult.INSTANCE.m1725closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        break;
                }
            }
        }
