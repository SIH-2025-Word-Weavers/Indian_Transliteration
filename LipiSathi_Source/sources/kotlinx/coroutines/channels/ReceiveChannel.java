...
public interface ReceiveChannel<E> {
    ...
    Object mo1705receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1706tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1706tryReceivePtdJZtk = receiveChannel.mo1706tryReceivePtdJZtk();
            if (ChannelResult.m1722isSuccessimpl(objMo1706tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1718getOrThrowimpl(objMo1706tryReceivePtdJZtk);
            }
            Throwable thM1716exceptionOrNullimpl = ChannelResult.m1716exceptionOrNullimpl(objMo1706tryReceivePtdJZtk);
            if (thM1716exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1716exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            switch (anonymousClass2.label) {
                case 0:
                    ...
                    objMo1705receiveCatchingJP2dKIU = receiveChannel.mo1705receiveCatchingJP2dKIU(anonymousClass2);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1705receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1717getOrNullimpl(objMo1705receiveCatchingJP2dKIU);
        }
