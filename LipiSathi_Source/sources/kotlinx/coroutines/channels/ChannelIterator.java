        ...
        public static /* synthetic */ Object next(ChannelIterator channelIterator, Continuation continuation) throws Throwable {
            ...
            switch (channelIterator$next0$2.label) {
                case 0:
                    ...
                    channelIterator$next0$2.L$0 = channelIterator;
                    channelIterator$next0$2.label = 1;
                    objHasNext = channelIterator.hasNext(channelIterator$next0$2);
                    if (objHasNext == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
                    channelIterator = (ChannelIterator) channelIterator$next0$2.L$0;
                    ResultKt.throwOnFailure($result);
                    objHasNext = $result;
                    break;
                default:
