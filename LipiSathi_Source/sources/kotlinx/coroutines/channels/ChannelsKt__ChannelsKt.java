...
final /* synthetic */ class ChannelsKt__ChannelsKt {
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        ...
                        r = Result.m200constructorimpl(Unit.INSTANCE);
                        if (Result.m207isSuccessimpl(r)) {
                            objM1725closedJP2dKIU = ChannelResult.INSTANCE.m1727successJP2dKIU(Unit.INSTANCE);
                        } else {
                            objM1725closedJP2dKIU = ChannelResult.INSTANCE.m1725closedJP2dKIU(Result.m203exceptionOrNullimpl(r));
                        }
                        Object r2 = ChannelResult.m1712boximpl(objM1725closedJP2dKIU);
                        return r2;
                    } catch (Throwable th2) {
                        th = th2;
                        Result.Companion companion2 = Result.INSTANCE;
                        r = Result.m200constructorimpl(ResultKt.createFailure(th));
                    }
                    break;
                case 1:
                    try {
                    ...
                    Object r3 = ChannelResult.m1712boximpl(objM1725closedJP2dKIU);
                    return r3;
                default:
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object $this$onSuccess_u2dWpGqRn0$iv = sendChannel.mo1707trySendJP2dKIU(e);
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (!ChannelResult.m1722isSuccessimpl(sendChannel.mo1707trySendJP2dKIU(e))) {
