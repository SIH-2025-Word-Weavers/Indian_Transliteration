...
public final class TimeoutKt {
    ...
    public static final <T> Object m1699withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1690toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
    ...
    public static final <T> Object m1700withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1690toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
