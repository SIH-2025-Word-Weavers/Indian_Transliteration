    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (anonymousClass2.label) {
            case 0:
                ...
                break;
            case 1:
                it = (Iterator) anonymousClass2.L$1;
                $this$asFlow_u24lambda_u2d7 = (FlowCollector) anonymousClass2.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
        ...
        while (it.hasNext()) {
            T next = it.next();
            anonymousClass2.L$0 = $this$asFlow_u24lambda_u2d7;
            anonymousClass2.L$1 = it;
            anonymousClass2.label = 1;
            Object value = $this$asFlow_u24lambda_u2d7.emit(next, anonymousClass2);
