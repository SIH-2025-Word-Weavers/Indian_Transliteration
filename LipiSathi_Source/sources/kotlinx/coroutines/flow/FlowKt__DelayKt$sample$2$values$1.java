...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1<T> implements FlowCollector {
        ...
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            FlowKt__DelayKt$sample$2$values$1$1$emit$1 flowKt__DelayKt$sample$2$values$1$1$emit$2 = flowKt__DelayKt$sample$2$values$1$1$emit$1;
            Object obj = flowKt__DelayKt$sample$2$values$1$1$emit$2.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (flowKt__DelayKt$sample$2$values$1$1$emit$2.label) {
                case 0:
                    ...
                    flowKt__DelayKt$sample$2$values$1$1$emit$2.label = 1;
                    if (producerScope.send(t, flowKt__DelayKt$sample$2$values$1$1$emit$2) == coroutine_suspended) {
