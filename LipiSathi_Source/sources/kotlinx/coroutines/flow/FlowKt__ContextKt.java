...
final /* synthetic */ class FlowKt__ContextKt {
    ...
    public static final <T> Flow<T> flowOn(Flow<? extends T> flow, CoroutineContext context) {
        ...
        return flow instanceof FusibleFlow ? FusibleFlow.DefaultImpls.fuse$default((FusibleFlow) flow, context, 0, null, 6, null) : new ChannelFlowOperatorImpl(flow, context, 0, null, 12, null);
    }
