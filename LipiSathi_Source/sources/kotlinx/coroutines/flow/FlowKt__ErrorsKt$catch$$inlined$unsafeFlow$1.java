    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (anonymousClass2.label) {
            case 0:
                ...
                anonymousClass2.L$0 = flowKt__ErrorsKt$catch$$inlined$unsafeFlow$1;
                anonymousClass2.L$1 = flowCollector2;
                anonymousClass2.label = 1;
                objCatchImpl = FlowKt.catchImpl(flow, flowCollector2, anonymousClass2);
                ...
                if (exception != null) {
                    ...
                    InlineMarker.mark(6);
                    objInvoke = function3.invoke(flowCollector2, exception, anonymousClass2);
                    InlineMarker.mark(7);
            ...
            case 1:
                ...
                flowKt__ErrorsKt$catch$$inlined$unsafeFlow$1 = (FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1) anonymousClass2.L$0;
                ResultKt.throwOnFailure($result);
                objCatchImpl = $result;
                exception = (Throwable) objCatchImpl;
                if (exception != null) {
                    Function3 function4 = flowKt__ErrorsKt$catch$$inlined$unsafeFlow$1.$action$inlined;
                    anonymousClass2.L$0 = null;
                    anonymousClass2.L$1 = null;
                    anonymousClass2.label = 2;
                    InlineMarker.mark(6);
                    objInvoke = function4.invoke(flowCollector2, exception, anonymousClass2);
                    InlineMarker.mark(7);
                    if (objInvoke == coroutine_suspended) {
                        return coroutine_suspended;
                    }
