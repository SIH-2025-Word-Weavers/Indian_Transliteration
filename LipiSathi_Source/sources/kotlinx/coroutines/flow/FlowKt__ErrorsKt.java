...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final <T> Flow<T> m1737catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
    ...
    public static final <T> Object catchImpl(Flow<? extends T> flow, FlowCollector<? super T> flowCollector, Continuation<? super Throwable> continuation) throws Throwable {
        ...
        switch (anonymousClass2.label) {
            case 0:
                ...
                try {
                    FlowCollector<? super Object> anonymousClass3 = new AnonymousClass2<>(flowCollector, objectRef2);
                    anonymousClass2.L$0 = objectRef2;
                    anonymousClass2.label = 1;
                    if (flow.collect(anonymousClass3, anonymousClass2) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    return null;
                } catch (Throwable th) {
        ...
        if (isSameExceptionAs$FlowKt__ErrorsKt(th, th3) || isCancellationCause$FlowKt__ErrorsKt(th, anonymousClass2.get$context())) {
            throw th;
        }
        if (th3 == null) {
            return th;
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            FlowKt__ErrorsKt$catchImpl$2$emit$1 flowKt__ErrorsKt$catchImpl$2$emit$2 = flowKt__ErrorsKt$catchImpl$2$emit$1;
            Object obj = flowKt__ErrorsKt$catchImpl$2$emit$2.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (flowKt__ErrorsKt$catchImpl$2$emit$2.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    try {
                        FlowCollector<T> flowCollector = this.$collector;
                        flowKt__ErrorsKt$catchImpl$2$emit$2.L$0 = this;
                        flowKt__ErrorsKt$catchImpl$2$emit$2.label = 1;
                        return flowCollector.emit(t, flowKt__ErrorsKt$catchImpl$2$emit$2) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    } catch (Throwable 
