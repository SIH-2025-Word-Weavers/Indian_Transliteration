...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public final Object emit(Flow<? extends T> flow, Continuation<? super Unit> continuation) throws Throwable {
            ...
            ChannelFlowMerge$collectTo$2$emit$1 channelFlowMerge$collectTo$2$emit$2 = channelFlowMerge$collectTo$2$emit$1;
            Object $result = channelFlowMerge$collectTo$2$emit$2.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (channelFlowMerge$collectTo$2$emit$2.label) {
                case 0:
                    ...
                    channelFlowMerge$collectTo$2$emit$2.L$0 = this;
                    channelFlowMerge$collectTo$2$emit$2.L$1 = flow;
                    channelFlowMerge$collectTo$2$emit$2.label = 1;
                    if (semaphore.acquire(channelFlowMerge$collectTo$2$emit$2) == coroutine_suspended) {
                    ...
                    break;
                case 1:
                    flow = (Flow) channelFlowMerge$collectTo$2$emit$2.L$1;
                    anonymousClass2 = (AnonymousClass2) channelFlowMerge$collectTo$2$emit$2.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
