        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            static final class C00071 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) throws Throwable {
                    C00071 c00071;
                    Object objMo1705receiveCatchingJP2dKIU;
                    FlowCollector flowCollector;
                    Object objInvoke;
                    C00071 c00072;
                    Throwable thM1716exceptionOrNullimpl;
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c00071 = this;
                            c00071.label = 1;
                            objMo1705receiveCatchingJP2dKIU = c00071.$second.mo1705receiveCatchingJP2dKIU(c00071);
                            if (objMo1705receiveCatchingJP2dKIU == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            flowCollector = c00071.$this_unsafeFlow;
                            if (objMo1705receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                                thM1716exceptionOrNullimpl = ChannelResult.m1716exceptionOrNullimpl(objMo1705receiveCatchingJP2dKIU);
                                if (thM1716exceptionOrNullimpl == null) {
                                    throw new AbortFlowException(flowCollector);
                                }
                                throw thM1716exceptionOrNullimpl;
                            }
                            Function3<T1, T2, Continuation<? super R>, Object> function3 = c00071.$transform;
                            T1 t1 = c00071.$value;
                            if (objMo1705receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                                objMo1705receiveCatchingJP2dKIU = null;
                            }
                            c00071.L$0 = flowCollector;
                            c00071.label = 2;
                            objInvoke = function3.invoke(t1, objMo1705receiveCatchingJP2dKIU, c00071);
                            ...
                            c00072.L$0 = null;
                            c00072.label = 3;
                            if (flowCollector2.emit(obj, c00072) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            return Unit.INSTANCE;
                        case 1:
                            c00071 = this;
                            ResultKt.throwOnFailure(obj);
                            objMo1705receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                            flowCollector = c00071.$this_unsafeFlow;
                            if (objMo1705receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                                thM1716exceptionOrNullimpl = ChannelResult.m1716exceptionOrNullimpl(objMo1705receiveCatchingJP2dKIU);
                                if (thM1716exceptionOrNullimpl == null) {
                            ...
                            Function3<T1, T2, Continuation<? super R>, Object> function4 = c00071.$transform;
                            T1 t2 = c00071.$value;
                            if (objMo1705receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                                objMo1705receiveCatchingJP2dKIU = null;
                            }
                            c00071.L$0 = flowCollector;
                            c00071.label = 2;
                            objInvoke = function4.invoke(t2, objMo1705receiveCatchingJP2dKIU, c00071);
                            if (objInvoke == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            obj = objInvoke;
            ...
            public final Object emit(T1 t1, Continuation<? super Unit> continuation) throws Throwable {
                ...
                switch (combineKt$zipImpl$1$1$2$1$emit$2.label) {
                    case 0:
                        ...
                        if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj, c00071, combineKt$zipImpl$1$1$2$1$emit$2) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        break;
                    case 1:
