...
public final class ChannelFlowTransformLatest<T, R> extends ChannelFlowOperator<T, R> {
    ...
    /* JADX INFO: compiled from: Merge.kt */
    @Metadata(d1 = {"\u0000\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\u0010\u0004\u001a\u00020\u0003\"\u0004\b\u0000\u0010\u0000\"\u0004\b\u0001\u0010\u0001*\u00020\u0002H\u008a@"}, d2 = {ExifInterface.GPS_DIRECTION_TRUE, "R", "Lkotlinx/coroutines/CoroutineScope;", "", "<anonymous>"}, k = 3, mv = {1, 6, 0})
    ...
    static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
                ...
                ChannelFlowTransformLatest$flowCollect$3$1$emit$1 channelFlowTransformLatest$flowCollect$3$1$emit$2 = channelFlowTransformLatest$flowCollect$3$1$emit$1;
                Object obj2 = channelFlowTransformLatest$flowCollect$3$1$emit$2.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch (channelFlowTransformLatest$flowCollect$3$1$emit$2.label) {
                    case 0:
                        ...
                        if (job != null) {
                            ...
                            channelFlowTransformLatest$flowCollect$3$1$emit$2.L$0 = anonymousClass1;
                            channelFlowTransformLatest$flowCollect$3$1$emit$2.L$1 = t;
                            channelFlowTransformLatest$flowCollect$3$1$emit$2.L$2 = job;
                            channelFlowTransformLatest$flowCollect$3$1$emit$2.label = 1;
                            if (job.join(channelFlowTransformLatest$flowCollect$3$1$emit$2) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            obj = t;
                            t = (T) obj;
                        ...
                        return Unit.INSTANCE;
                    case 1:
                        obj = channelFlowTransformLatest$flowCollect$3$1$emit$2.L$1;
                        anonymousClass1 = (AnonymousClass1) channelFlowTransformLatest$flowCollect$3$1$emit$2.L$0;
                        ResultKt.throwOnFailure(obj2);
                        t = (T) obj;
                        anonymousClass1.$previousFlow.element = (T) BuildersKt__Builders_commonKt.launch$default(anonymousClass1.$$this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass2(anonymousClass1.this$0, anonymousClass1.$collector, t, null), 1, null);
                        return Unit.INSTANCE;
