...
final class CombineKt$zipImpl$1$1$second$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1<T> implements FlowCollector {
        ...
        public final Object emit(T2 t2, Continuation<? super Unit> continuation) throws Throwable {
            ...
            CombineKt$zipImpl$1$1$second$1$1$emit$1 combineKt$zipImpl$1$1$second$1$1$emit$2 = combineKt$zipImpl$1$1$second$1$1$emit$1;
            Object obj = combineKt$zipImpl$1$1$second$1$1$emit$2.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (combineKt$zipImpl$1$1$second$1$1$emit$2.label) {
                case 0:
                    ...
                    combineKt$zipImpl$1$1$second$1$1$emit$2.label = 1;
                    if (channel.send(obj2, combineKt$zipImpl$1$1$second$1$1$emit$2) == coroutine_suspended) {
