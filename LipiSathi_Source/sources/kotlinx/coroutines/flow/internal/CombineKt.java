...
public final class CombineKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Code duplicated, block: B:19:0x00ea A[RETURN] */
        /* JADX WARN: Code duplicated, block: B:20:0x00eb  */
        /* JADX WARN: Code duplicated, block: B:23:0x00f4  */
        /* JADX WARN: Code duplicated, block: B:25:0x00f8 A[LOOP_START, PHI: r6 r9
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        try {
                            ...
                            int i = this.$i;
                            this.label = 1;
                            if (flowArr[i].collect(new C00061(this.$resultChannel, i), this) == coroutine_suspended) {
            ...
            static final class C00061<T> implements FlowCollector {
                ...
                public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
                    ...
                    CombineKt$combineInternal$2$1$1$emit$1 combineKt$combineInternal$2$1$1$emit$2 = combineKt$combineInternal$2$1$1$emit$1;
                    Object $result = combineKt$combineInternal$2$1$1$emit$2.result;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    switch (combineKt$combineInternal$2$1$1$emit$2.label) {
                        case 0:
                            ResultKt.throwOnFailure($result);
                            Channel<IndexedValue<Object>> channel = this.$resultChannel;
                            IndexedValue<Object> indexedValue = new IndexedValue<>(this.$i, t);
                            combineKt$combineInternal$2$1$1$emit$2.label = 1;
                            Object value = channel.send(indexedValue, combineKt$combineInternal$2$1$1$emit$2);
                            if (value == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            combineKt$combineInternal$2$1$1$emit$2.label = 2;
                            if (YieldKt.yield(combineKt$combineInternal$2$1$1$emit$2) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            return Unit.INSTANCE;
                        case 1:
