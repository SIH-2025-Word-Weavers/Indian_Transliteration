    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        static final class C00051<T> implements FlowCollector {
            ...
            public final Object emit(int count, Continuation<? super Unit> continuation) throws Throwable {
                ...
                StartedLazily$command$1$1$emit$1 startedLazily$command$1$1$emit$2 = startedLazily$command$1$1$emit$1;
                Object $result = startedLazily$command$1$1$emit$2.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch (startedLazily$command$1$1$emit$2.label) {
                    case 0:
                        ResultKt.throwOnFailure($result);
                        if (count > 0 && !this.$started.element) {
                            ...
                            startedLazily$command$1$1$emit$2.label = 1;
                            if (flowCollector.emit(sharingCommand, startedLazily$command$1$1$emit$2) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        }
                        break;
