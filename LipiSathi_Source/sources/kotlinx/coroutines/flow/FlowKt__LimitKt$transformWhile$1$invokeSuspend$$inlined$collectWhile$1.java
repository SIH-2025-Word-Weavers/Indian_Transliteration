    ...
    public Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (anonymousClass2.label) {
            case 0:
                ...
                InlineMarker.mark(6);
                objInvoke = function3.invoke(flowCollector, t, anonymousClass2);
                InlineMarker.mark(7);
                ...
                break;
            case 1:
                flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1) anonymousClass2.L$0;
                ResultKt.throwOnFailure($result);
                objInvoke = $result;
                break;
            default:
