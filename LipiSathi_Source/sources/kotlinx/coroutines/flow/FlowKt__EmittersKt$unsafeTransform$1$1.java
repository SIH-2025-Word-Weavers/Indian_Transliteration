...
public final class FlowKt__EmittersKt$unsafeTransform$1$1<T> implements FlowCollector {
    ...
    public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        FlowKt__EmittersKt$unsafeTransform$1$1$emit$1 flowKt__EmittersKt$unsafeTransform$1$1$emit$2 = flowKt__EmittersKt$unsafeTransform$1$1$emit$1;
        Object $result = flowKt__EmittersKt$unsafeTransform$1$1$emit$2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (flowKt__EmittersKt$unsafeTransform$1$1$emit$2.label) {
            case 0:
                ...
                flowKt__EmittersKt$unsafeTransform$1$1$emit$2.label = 1;
                Object value = function3.invoke(obj, t, flowKt__EmittersKt$unsafeTransform$1$1$emit$2);
