    ...
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (anonymousClass2.label) {
            case 0:
                ...
                anonymousClass2.L$0 = flowKt__TransformKt$runningFold$$inlined$unsafeFlow$1;
                anonymousClass2.L$1 = $this$runningFold_u24lambda_u2d8;
                anonymousClass2.L$2 = accumulator;
                anonymousClass2.label = 1;
                if ($this$runningFold_u24lambda_u2d8.emit(t, anonymousClass2) == coroutine_suspended) {
                ...
                if (flow.collect(flowKt__TransformKt$runningFold$1$1, anonymousClass2) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Unit.INSTANCE;
            case 1:
                accumulator = (Ref.ObjectRef) anonymousClass2.L$2;
                $this$runningFold_u24lambda_u2d8 = (FlowCollector) anonymousClass2.L$1;
                flowKt__TransformKt$runningFold$$inlined$unsafeFlow$1 = (FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1) anonymousClass2.L$0;
                ResultKt.throwOnFailure($result);
                flow = flowKt__TransformKt$runningFold$$inlined$unsafeFlow$1.$this_runningFold$inlined;
                flowKt__TransformKt$runningFold$1$1 = new FlowKt__TransformKt$runningFold$1$1(accumulator, flowKt__TransformKt$runningFold$$inlined$unsafeFlow$1.$operation$inlined, $this$runningFold_u24lambda_u2d8);
                anonymousClass2.L$0 = null;
