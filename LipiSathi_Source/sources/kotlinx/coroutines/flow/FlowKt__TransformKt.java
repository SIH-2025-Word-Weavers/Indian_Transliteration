                    ...
                    switch (anonymousClass2.label) {
                        case 0:
                            ...
                            if (t != null) {
                                ...
                                Object value = $this$filterNotNull_u24lambda_u2d3.emit(t, anonymousClass2);
                ...
                public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
                    ...
                    switch (anonymousClass2.label) {
                        case 0:
                            ...
                            anonymousClass2.label = 1;
                            InlineMarker.mark(6);
                            Object objInvoke = function2.invoke(t, anonymousClass2);
                            InlineMarker.mark(7);
                            ...
                            if (flowCollector.emit(obj, anonymousClass2) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            return Unit.INSTANCE;
                        case 1:
                            FlowCollector flowCollector3 = (FlowCollector) anonymousClass2.L$1;
                            obj = anonymousClass2.L$0;
                            ResultKt.throwOnFailure(obj2);
