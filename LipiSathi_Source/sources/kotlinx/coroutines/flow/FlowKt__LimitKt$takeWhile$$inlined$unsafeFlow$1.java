    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (anonymousClass2.label) {
            case 0:
                ...
                try {
                    anonymousClass2.L$0 = collector$iv2;
                    anonymousClass2.label = 1;
                    return $this$collectWhile$iv.collect(collector$iv2, anonymousClass2) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                ...
                break;
            case 1:
                collector$iv = (FlowKt__LimitKt$takeWhile$lambda6$$inlined$collectWhile$1) anonymousClass2.L$0;
                try {
                    ResultKt.throwOnFailure($result);
