...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0004\u001a\u00020\u0003\"\u0004\b\u0000\u0010\u0000*\b\u0012\u0004\u0012\u00020\u00020\u0001H\u008a@"}, d2 = {ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/channels/ProducerScope;", "", "", "<anonymous>"}, k = 3, mv = {1, 6, 0})
...
final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1<T> implements FlowCollector {
        ...
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            FlowKt__DelayKt$debounceInternal$1$values$1$1$emit$1 flowKt__DelayKt$debounceInternal$1$values$1$1$emit$2 = flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1;
            Object obj = flowKt__DelayKt$debounceInternal$1$values$1$1$emit$2.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (flowKt__DelayKt$debounceInternal$1$values$1$1$emit$2.label) {
                case 0:
                    ...
                    flowKt__DelayKt$debounceInternal$1$values$1$1$emit$2.label = 1;
                    if (producerScope.send(t, flowKt__DelayKt$debounceInternal$1$values$1$1$emit$2) == coroutine_suspended) {
