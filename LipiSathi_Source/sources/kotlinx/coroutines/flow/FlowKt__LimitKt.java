...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    public static final <T> Object emitAbort$FlowKt__LimitKt(FlowCollector<? super T> flowCollector, T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        FlowKt__LimitKt$emitAbort$1 flowKt__LimitKt$emitAbort$2 = flowKt__LimitKt$emitAbort$1;
        Object $result = flowKt__LimitKt$emitAbort$2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (flowKt__LimitKt$emitAbort$2.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                flowKt__LimitKt$emitAbort$2.L$0 = flowCollector;
                flowKt__LimitKt$emitAbort$2.label = 1;
                Object value = flowCollector.emit(t, flowKt__LimitKt$emitAbort$2);
                if (value == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:
                flowCollector = (FlowCollector) flowKt__LimitKt$emitAbort$2.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
    ...
    public static final <T> Object collectWhile(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (anonymousClass2.label) {
            case 0:
                ...
                try {
                    anonymousClass2.L$0 = collector2;
                    anonymousClass2.label = 1;
                    return flow.collect(collector2, anonymousClass2) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                } catch (AbortFlowException e) {
                    e = e;
                ...
                break;
            case 1:
                collector = (FlowKt__LimitKt$collectWhile$collector$1) anonymousClass2.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                } catch (AbortFlowException e2) {
                    e = e2;
