...
final class FlowKt__LimitKt$take$2$1<T> implements FlowCollector {
    ...
    public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        FlowKt__LimitKt$take$2$1$emit$1 flowKt__LimitKt$take$2$1$emit$2 = flowKt__LimitKt$take$2$1$emit$1;
        Object $result = flowKt__LimitKt$take$2$1$emit$2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (flowKt__LimitKt$take$2$1$emit$2.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                this.$consumed.element++;
                if (this.$consumed.element < this.$count) {
                    FlowCollector<T> flowCollector = this.$this_unsafeFlow;
                    flowKt__LimitKt$take$2$1$emit$2.label = 1;
                    Object value = flowCollector.emit(t, flowKt__LimitKt$take$2$1$emit$2);
                    if (value == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    FlowCollector<T> flowCollector2 = this.$this_unsafeFlow;
                    flowKt__LimitKt$take$2$1$emit$2.label = 2;
                    Object value2 = FlowKt__LimitKt.emitAbort$FlowKt__LimitKt(flowCollector2, t, flowKt__LimitKt$take$2$1$emit$2);
