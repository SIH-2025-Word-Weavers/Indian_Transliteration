...
final class FlowKt__LimitKt$drop$2$1<T> implements FlowCollector {
    ...
    public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        FlowKt__LimitKt$drop$2$1$emit$1 flowKt__LimitKt$drop$2$1$emit$2 = flowKt__LimitKt$drop$2$1$emit$1;
        Object $result = flowKt__LimitKt$drop$2$1$emit$2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (flowKt__LimitKt$drop$2$1$emit$2.label) {
            case 0:
                ...
                flowKt__LimitKt$drop$2$1$emit$2.label = 1;
                Object value = flowCollector.emit(t, flowKt__LimitKt$drop$2$1$emit$2);
