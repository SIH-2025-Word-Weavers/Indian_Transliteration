...
final class FlowKt__TransformKt$runningFold$1$1<T> implements FlowCollector {
    ...
    /* JADX WARN: Code duplicated, block: B:20:0x0071 A[RETURN] */
    ...
    public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        FlowKt__TransformKt$runningFold$1$1$emit$1 flowKt__TransformKt$runningFold$1$1$emit$2 = flowKt__TransformKt$runningFold$1$1$emit$1;
        Object obj = flowKt__TransformKt$runningFold$1$1$emit$2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (flowKt__TransformKt$runningFold$1$1$emit$2.label) {
            case 0:
                ...
                flowKt__TransformKt$runningFold$1$1$emit$2.L$1 = objectRef2;
                flowKt__TransformKt$runningFold$1$1$emit$2.label = 1;
                Object objInvoke = function3.invoke((R) t4, t, flowKt__TransformKt$runningFold$1$1$emit$2);
                ...
                if (flowCollector.emit((R) t3, flowKt__TransformKt$runningFold$1$1$emit$2) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Unit.INSTANCE;
            case 1:
                objectRef = (Ref.ObjectRef) flowKt__TransformKt$runningFold$1$1$emit$2.L$1;
                FlowKt__TransformKt$runningFold$1$1<T> flowKt__TransformKt$runningFold$1$2 = (FlowKt__TransformKt$runningFold$1$1) flowKt__TransformKt$runningFold$1$1$emit$2.L$0;
                ResultKt.throwOnFailure(obj);
                flowKt__TransformKt$runningFold$1$1 = flowKt__TransformKt$runningFold$1$2;
                t2 = (T) obj;
                objectRef.element = t2;
                flowCollector = flowKt__TransformKt$runningFold$1$1.$this_unsafeFlow;
                t3 = flowKt__TransformKt$runningFold$1$1.$accumulator.element;
