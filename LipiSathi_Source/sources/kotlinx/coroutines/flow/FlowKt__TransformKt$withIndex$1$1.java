...
final class FlowKt__TransformKt$withIndex$1$1<T> implements FlowCollector {
    ...
    public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        FlowKt__TransformKt$withIndex$1$1$emit$1 flowKt__TransformKt$withIndex$1$1$emit$2 = flowKt__TransformKt$withIndex$1$1$emit$1;
        Object $result = flowKt__TransformKt$withIndex$1$1$emit$2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (flowKt__TransformKt$withIndex$1$1$emit$2.label) {
            case 0:
                ...
                if (index$iv >= 0) {
                    ...
                    Object value = flowCollector.emit(indexedValue, flowKt__TransformKt$withIndex$1$1$emit$2);
