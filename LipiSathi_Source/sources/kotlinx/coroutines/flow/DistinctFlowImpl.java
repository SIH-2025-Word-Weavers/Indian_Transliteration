...
final class DistinctFlowImpl<T> implements Flow<T> {
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            DistinctFlowImpl$collect$2$emit$1 distinctFlowImpl$collect$2$emit$2 = distinctFlowImpl$collect$2$emit$1;
            Object obj = distinctFlowImpl$collect$2$emit$2.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (distinctFlowImpl$collect$2$emit$2.label) {
                case 0:
                    ...
                    if (this.$previousKey.element == NullSurrogateKt.NULL || !this.this$0.areEquivalent.invoke(this.$previousKey.element, t2).booleanValue()) {
                        ...
                        distinctFlowImpl$collect$2$emit$2.label = 1;
                        if (flowCollector.emit(t, distinctFlowImpl$collect$2$emit$2) == coroutine_suspended) {
