...
final class FlowKt__LimitKt$dropWhile$1$1<T> implements FlowCollector {
    ...
    public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        FlowKt__LimitKt$dropWhile$1$1$emit$1 flowKt__LimitKt$dropWhile$1$1$emit$2 = flowKt__LimitKt$dropWhile$1$1$emit$1;
        Object obj = flowKt__LimitKt$dropWhile$1$1$emit$2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (flowKt__LimitKt$dropWhile$1$1$emit$2.label) {
            case 0:
                ...
                if (flowKt__LimitKt$dropWhile$1$1.$matched.element) {
                    ...
                    flowKt__LimitKt$dropWhile$1$1$emit$2.label = 1;
                    if (flowCollector2.emit(t, flowKt__LimitKt$dropWhile$1$1$emit$2) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    Function2<T, Continuation<? super Boolean>, Object> function2 = flowKt__LimitKt$dropWhile$1$1.$predicate;
                    flowKt__LimitKt$dropWhile$1$1$emit$2.L$0 = flowKt__LimitKt$dropWhile$1$1;
                    flowKt__LimitKt$dropWhile$1$1$emit$2.L$1 = t;
                    flowKt__LimitKt$dropWhile$1$1$emit$2.label = 2;
                    objInvoke = function2.invoke(t, flowKt__LimitKt$dropWhile$1$1$emit$2);
                    ...
                    if (!((Boolean) objInvoke).booleanValue()) {
                        ...
                        flowKt__LimitKt$dropWhile$1$1$emit$2.L$0 = null;
                        flowKt__LimitKt$dropWhile$1$1$emit$2.L$1 = null;
                        flowKt__LimitKt$dropWhile$1$1$emit$2.label = 3;
                        if (flowCollector.emit(t, flowKt__LimitKt$dropWhile$1$1$emit$2) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                }
            ...
            case 3:
                ...
                return Unit.INSTANCE;
            case 2:
                t = (T) flowKt__LimitKt$dropWhile$1$1$emit$2.L$1;
                flowKt__LimitKt$dropWhile$1$1 = (FlowKt__LimitKt$dropWhile$1$1) flowKt__LimitKt$dropWhile$1$1$emit$2.L$0;
                ResultKt.throwOnFailure(obj);
                objInvoke = obj;
                if (!((Boolean) objInvoke).booleanValue()) {
                    flowKt__LimitKt$dropWhile$1$1.$matched.element = true;
