...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARN: Code duplicated, block: B:32:0x00aa A[Catch: all -> 0x00d8, TryCatch #0 {all -> 0x00d8, blocks: (B:13:0x003d, B:30:0x00a1, B:32:0x00aa, B:37:0x00bf, B:38:0x00c2, B:16:0x0055, B:19:0x0067, B:28:0x008f, B:22:0x0077, B:24:0x007b), top: B:46:0x0022 }] */
    /* JADX WARN: Code duplicated, block: B:37:0x00bf A[Catch: all -> 0x00d8, TryCatch #0 {all -> 0x00d8, blocks: (B:13:0x003d, B:30:0x00a1, B:32:0x00aa, B:37:0x00bf, B:38:0x00c2, B:16:0x0055, B:19:0x0067, B:28:0x008f, B:22:0x0077, B:24:0x007b), top: B:46:0x0022 }] */
    /* JADX WARN: Code duplicated, block: B:40:0x00d3 A[RETURN] */
    /* JADX WARN: Code duplicated, block: B:41:0x00d4  */
    /* JADX WARN: Code duplicated, block: B:50:0x00bd A[SYNTHETIC] */
    ...
    /*  JADX ERROR: JadxOverflowException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxOverflowException: Regions count limit reached at block B:41:0x00d4
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation<Unit> continuation2 : continuationArrFindSlotsToResumeLocked) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m200constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    public final Continuation<Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long oldIndex) {
        ...
        if (getNCollectors() > 0) {
            ...
            iMin = Math.min(this.queueSize, this.bufferCapacity - newBufferSize0);
        } else {
            iMin = this.queueSize;
        }
