...
final class CancellableFlowImpl<T> implements CancellableFlow<T> {
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            CancellableFlowImpl$collect$2$emit$1 cancellableFlowImpl$collect$2$emit$2 = cancellableFlowImpl$collect$2$emit$1;
            Object $result = cancellableFlowImpl$collect$2$emit$2.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (cancellableFlowImpl$collect$2$emit$2.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    JobKt.ensureActive(cancellableFlowImpl$collect$2$emit$2.getContext());
                    FlowCollector<T> flowCollector = this.$collector;
                    cancellableFlowImpl$collect$2$emit$2.label = 1;
                    Object it = flowCollector.emit(t, cancellableFlowImpl$collect$2$emit$2);
