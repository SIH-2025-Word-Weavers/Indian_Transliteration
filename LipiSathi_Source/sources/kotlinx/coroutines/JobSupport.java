...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final Throwable getFinalRootCause(Finishing state, List<? extends Throwable> exceptions) {
        ...
        do {
            ...
            element$iv = it.next();
        } while (!(!(((Throwable) element$iv) instanceof CancellationException)));
        ...
        if (first instanceof TimeoutCancellationException) {
            ...
            for (Object element$iv2 : $this$firstOrNull$iv2) {
                Throwable it2 = (Throwable) element$iv2;
                if (it2 != first && (it2 instanceof TimeoutCancellationException)) {
                    obj = element$iv2;
                    break;
                }
            }
            ...
            if (cur$iv instanceof LockFreeLinkedListNode) {
                ...
                try {
                    ...
                    if (th != null) {
                        ...
                        JobSupport $this$notifyHandlers_u24lambda_u2d14_u24lambda_u2d14 = this;
                        exception = new CompletionHandlerException("Exception in completion handler " + node + " for " + $this$notifyHandlers_u24lambda_u2d14_u24lambda_u2d14, ex);
                        Unit unit2 = Unit.INSTANCE;
                    }
                }
            }
    ...
    private final String stateString(Object state) {
        if (state instanceof Finishing) {
            ...
            return ((Finishing) state).isCompleting() ? "Completing" : "Active";
        }
        if (state instanceof Incomplete) {
