...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM200constructorimpl = Result.m200constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM200constructorimpl = Result.m200constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m206isFailureimpl(objM200constructorimpl) ? null : objM200constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1729installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1729installSignalHandler$lambda1(Signal it) {
