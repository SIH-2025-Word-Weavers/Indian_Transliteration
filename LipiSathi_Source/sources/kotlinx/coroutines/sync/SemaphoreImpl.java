...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cont) {
        Object objM1755constructorimpl;
        Object s$iv;
        boolean z;
        ...
        while (true) {
            SemaphoreSegment $this$findSegmentInternal$iv$iv = curTail;
            ...
            while (true) {
                if (cur$iv$iv.getId() < id$iv || cur$iv$iv.getRemoved()) {
                    ...
                    if (it$iv$iv$iv == ConcurrentLinkedListKt.CLOSED) {
                        objM1755constructorimpl = SegmentOrClosed.m1755constructorimpl(ConcurrentLinkedListKt.CLOSED);
                        break;
                    }
                    ...
                    objM1755constructorimpl = SegmentOrClosed.m1755constructorimpl(cur$iv$iv);
                    curTail = curTail;
                    break;
                }
            }
            s$iv = objM1755constructorimpl;
            if (SegmentOrClosed.m1760isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1758getSegmentimpl(s$iv);
            while (true) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m1758getSegmentimpl(s$iv);
