...
public final class DelayKt {
    ...
    public static final Object awaitCancellation(Continuation<?> continuation) throws Throwable {
        ...
        switch (anonymousClass2.label) {
            case 0:
                ...
                AnonymousClass1 uCont$iv = anonymousClass2;
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo1753scheduleResumeAfterDelay(timeMillis, cont);
        }
        Object result = cancellable$iv.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m1689delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1690toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1690toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1524compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.INSTANCE.m1628getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1543getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1L);
        }
        return 0L;
    }
}
