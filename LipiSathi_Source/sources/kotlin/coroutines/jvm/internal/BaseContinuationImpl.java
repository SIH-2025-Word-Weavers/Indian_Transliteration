...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                Object outcome = $this$resumeWith_u24lambda_u240.invokeSuspend(param);
                if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    return;
                }
                Result.Companion companion = Result.INSTANCE;
                objM200constructorimpl = Result.m200constructorimpl(outcome);
            } catch (Throwable exception) {
                Result.Companion companion2 = Result.INSTANCE;
                objM200constructorimpl = Result.m200constructorimpl(ResultKt.createFailure(exception));
            }
            Object outcome2 = objM200constructorimpl;
