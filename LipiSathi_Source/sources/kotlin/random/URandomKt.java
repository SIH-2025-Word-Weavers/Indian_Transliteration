...
public final class URandomKt {
    public static final int nextUInt(Random $this$nextUInt) {
        ...
        return UInt.m295constructorimpl($this$nextUInt.nextInt());
    }

    /* JADX INFO: renamed from: nextUInt-qCasIEU, reason: not valid java name */
    public static final int m1420nextUIntqCasIEU(Random nextUInt, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        return m1419nextUInta8DCA5k(nextUInt, 0, until);
    }

    /* JADX INFO: renamed from: nextUInt-a8DCA5k, reason: not valid java name */
    public static final int m1419nextUInta8DCA5k(Random nextUInt, int from, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        m1414checkUIntRangeBoundsJ1ME1BU(from, until);
        ...
        return UInt.m295constructorimpl(signedResult);
    }
    ...
    public static final int nextUInt(Random $this$nextUInt, UIntRange range) {
        ...
        if (Integer.compare(range.getLast() ^ Integer.MIN_VALUE, (-1) ^ Integer.MIN_VALUE) < 0) {
            return m1419nextUInta8DCA5k($this$nextUInt, range.getFirst(), UInt.m295constructorimpl(range.getLast() + 1));
        }
        return Integer.compare(range.getFirst() ^ Integer.MIN_VALUE, 0 ^ Integer.MIN_VALUE) > 0 ? UInt.m295constructorimpl(m1419nextUInta8DCA5k($this$nextUInt, UInt.m295constructorimpl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt($this$nextUInt);
    }

    public static final long nextULong(Random $this$nextULong) {
        Intrinsics.checkNotNullParameter($this$nextULong, "<this>");
        return ULong.m374constructorimpl($this$nextULong.nextLong());
    }

    /* JADX INFO: renamed from: nextULong-V1Xi4fY, reason: not valid java name */
    public static final long m1421nextULongV1Xi4fY(Random nextULong, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        return m1422nextULongjmpaWc(nextULong, 0L, until);
    }

    /* JADX INFO: renamed from: nextULong-jmpaW-c, reason: not valid java name */
    public static final long m1422nextULongjmpaWc(Random nextULong, long from, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        m1415checkULongRangeBoundseb3DHEI(from, until);
        ...
        return ULong.m374constructorimpl(signedResult);
    }
    ...
    public static final long nextULong(Random $this$nextULong, ULongRange range) {
        ...
        if (Long.compare(range.getLast() ^ Long.MIN_VALUE, (-1) ^ Long.MIN_VALUE) < 0) {
            return m1422nextULongjmpaWc($this$nextULong, range.getFirst(), ULong.m374constructorimpl(range.getLast() + ULong.m374constructorimpl(((long) 1) & 4294967295L)));
        }
        if (Long.compare(range.getFirst() ^ Long.MIN_VALUE, 0 ^ Long.MIN_VALUE) <= 0) {
            return nextULong($this$nextULong);
        }
        long j = ((long) 1) & 4294967295L;
        return ULong.m374constructorimpl(m1422nextULongjmpaWc($this$nextULong, ULong.m374constructorimpl(range.getFirst() - ULong.m374constructorimpl(j)), range.getLast()) + ULong.m374constructorimpl(j));
    }

    /* JADX INFO: renamed from: nextUBytes-EVgfTAA, reason: not valid java name */
    public static final byte[] m1416nextUBytesEVgfTAA(Random nextUBytes, byte[] array) {
    ...
    public static final byte[] nextUBytes(Random $this$nextUBytes, int size) {
        ...
        return UByteArray.m271constructorimpl($this$nextUBytes.nextBytes(size));
    }

    /* JADX INFO: renamed from: nextUBytes-Wvrt4B4$default, reason: not valid java name */
    public static /* synthetic */ byte[] m1418nextUBytesWvrt4B4$default(Random random, byte[] bArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m1417nextUBytesWvrt4B4(random, bArr, i, i2);
    }

    /* JADX INFO: renamed from: nextUBytes-Wvrt4B4, reason: not valid java name */
    public static final byte[] m1417nextUBytesWvrt4B4(Random nextUBytes, byte[] array, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter(nextUBytes, "$this$nextUBytes");
        Intrinsics.checkNotNullParameter(array, "array");
    ...
    public static final void m1414checkUIntRangeBoundsJ1ME1BU(int from, int until) {
        if (!(Integer.compare(until ^ Integer.MIN_VALUE, from ^ Integer.MIN_VALUE) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m289boximpl(from), UInt.m289boximpl(until)).toString());
        }
    }

    /* JADX INFO: renamed from: checkULongRangeBounds-eb3DHEI, reason: not valid java name */
    public static final void m1415checkULongRangeBoundseb3DHEI(long from, long until) {
        if (!(Long.compare(until ^ Long.MIN_VALUE, from ^ Long.MIN_VALUE) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m368boximpl(from), ULong.m368boximpl(until)).toString());
        }
    }
}
