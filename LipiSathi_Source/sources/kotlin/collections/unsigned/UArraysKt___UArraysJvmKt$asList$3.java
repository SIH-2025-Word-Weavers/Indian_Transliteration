...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof UByte) {
            return m715contains7apg3OU(((UByte) element).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int index) {
        return UByte.m212boximpl(m716getw2LRezQ(index));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object element) {
        if (element instanceof UByte) {
            return m717indexOf7apg3OU(((UByte) element).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object element) {
        if (element instanceof UByte) {
            return m718lastIndexOf7apg3OU(((UByte) element).getData());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UByteArray.m277getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UByteArray.m279isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-7apg3OU, reason: not valid java name */
    public boolean m715contains7apg3OU(byte element) {
        return UByteArray.m272contains7apg3OU(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-w2LRezQ, reason: not valid java name */
    public byte m716getw2LRezQ(int index) {
        return UByteArray.m276getw2LRezQ(this.$this_asList, index);
    }
