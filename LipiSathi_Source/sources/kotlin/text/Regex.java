...
public final class Regex implements Serializable {
    ...
    static final class C00671 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Code duplicated, block: B:25:0x00a3 A[RETURN] */
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (splitCount != c00671.$limit - 1 || !matcher.find()) {
                        charSequence = c00671.$input;
                        c00671.L$0 = null;
                        c00671.L$1 = null;
                        c00671.label = 3;
                        if ($this$sequence.yield(charSequence.subSequence(nextStart, charSequence.length()).toString(), c00671) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
