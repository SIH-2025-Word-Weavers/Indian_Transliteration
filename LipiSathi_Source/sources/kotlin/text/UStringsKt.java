...
public final class UStringsKt {
    ...
    public static final String m1512toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1514toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1513toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1511toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m295constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m295constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m475boximpl(UShort.m481constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m295constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m295constructorimpl(result * uradix);
            result = UInt.m295constructorimpl(UInt.m295constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m289boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m374constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m374constructorimpl(result * uradix);
            result = ULong.m374constructorimpl(ULong.m374constructorimpl(((long) UInt.m295constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m368boximpl(result);
    }
}
