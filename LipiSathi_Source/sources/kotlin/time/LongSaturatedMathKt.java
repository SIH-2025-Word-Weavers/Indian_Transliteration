...
public final class LongSaturatedMathKt {
    ...
    public static final long m1654saturatingAddNuflL3o(long value, DurationUnit unit, long duration) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long durationInUnit = Duration.m1571toLongimpl(duration, unit);
        if (((value - 1) | 1) == Long.MAX_VALUE) {
            return m1653checkInfiniteSumDefinedPjuGub4(value, duration, durationInUnit);
        }
        if ((1 | (durationInUnit - 1)) == Long.MAX_VALUE) {
            return m1655saturatingAddInHalvesNuflL3o(value, unit, duration);
        }
    ...
    private static final long m1653checkInfiniteSumDefinedPjuGub4(long value, long duration, long durationInUnit) {
        if (!Duration.m1557isInfiniteimpl(duration) || (value ^ durationInUnit) >= 0) {
            return value;
        }
    ...
    private static final long m1655saturatingAddInHalvesNuflL3o(long value, DurationUnit unit, long duration) {
        long half = Duration.m1528divUwyO8pc(duration, 2);
        long halfInUnit = Duration.m1571toLongimpl(half, unit);
        if (!((1 | (halfInUnit - 1)) == Long.MAX_VALUE)) {
            return m1654saturatingAddNuflL3o(m1654saturatingAddNuflL3o(value, unit, half), unit, Duration.m1560minusLRDsOJo(duration, half));
        }
        return halfInUnit;
    }
    ...
    private static final long infinityOfSign(long value) {
        ...
        return value < 0 ? companion.m1627getNEG_INFINITEUwyO8pc$kotlin_stdlib() : companion.m1626getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long valueNs, long origin, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (origin - 1)) == Long.MAX_VALUE) {
            return Duration.m1578unaryMinusUwyO8pc(infinityOfSign(origin));
        }
    ...
    public static final long saturatingOriginsDiff(long origin1, long origin2, DurationUnit unit) {
        ...
        if ($i$f$isSaturated != 0) {
            return origin1 == origin2 ? Duration.INSTANCE.m1628getZEROUwyO8pc() : Duration.m1578unaryMinusUwyO8pc(infinityOfSign(origin2));
        }
    ...
    private static final long saturatingFiniteDiff(long value1, long value2, DurationUnit unit) {
        ...
        if (((result ^ value1) & (~(result ^ value2))) < 0) {
            if (unit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                Duration.Companion companion = Duration.INSTANCE;
                return Duration.m1561plusLRDsOJo(DurationKt.toDuration(resultMs, DurationUnit.MILLISECONDS), DurationKt.toDuration(resultUnit, unit));
            }
            return Duration.m1578unaryMinusUwyO8pc(infinityOfSign(result));
        }
