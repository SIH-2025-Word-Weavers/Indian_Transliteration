...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1515elapsedNowUwyO8pc() {
            return Duration.m1560minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1518plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1561plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1517minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1530equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1557isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1628getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1560minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m1530equalsimpl0(startedAtDiff, Duration.m1578unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m1628getZEROUwyO8pc() : Duration.m1561plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1530equalsimpl0(mo1517minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1628getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1553hashCodeimpl(Duration.m1561plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1574toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1628getZEROUwyO8pc(), null);
    }
}
