...
public final class DurationKt {
    ...
    private static final long m1652timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1563timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1651timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1562timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code duplicated, block: B:184:0x00e1 A[EDGE_INSN: B:184:0x00e1->B:52:0x00e1 BREAK  A[LOOP:1: B:39:0x0087->B:50:0x00c6], SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:50:0x00c6 A[LOOP:1: B:39:0x0087->B:50:0x00c6, LOOP_END] */
    public static final long parseDuration(String value, boolean strictIso) {
        ...
        long result = Duration.INSTANCE.m1628getZEROUwyO8pc();
        ...
        if (value.charAt(index) == 'P') {
            ...
            while (index2 < length3) {
                if (value.charAt(index2) == 'T') {
                    ...
                    if (unit == DurationUnit.SECONDS && dotIndex > 0) {
                        ...
                        String str5 = str3;
                        long result2 = Duration.m1561plusLRDsOJo(result, toDuration(parseOverLongIsoComponent(whole), unit));
                        Intrinsics.checkNotNull(component, str5);
                        String strSubstring = component.substring(dotIndex);
                        Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String).substring(startIndex)");
                        result = Duration.m1561plusLRDsOJo(result2, toDuration(Double.parseDouble(strSubstring), unit));
                        str3 = str5;
                        nonDigitSymbols2 = nonDigitSymbols;
                        length3 = length2;
                        isNegative3 = isNegative2;
                        ...
                        result = Duration.m1561plusLRDsOJo(result, toDuration(parseOverLongIsoComponent(component), unit));
                        str3 = str3;
                        nonDigitSymbols2 = nonDigitSymbols;
                        length3 = length2;
                        isNegative3 = isNegative2;
            ...
            if (!strictIso) {
                ...
                if (StringsKt.regionMatches(value, index, "Infinity", 0, Math.max(length3 - index, "Infinity".length()), true)) {
                    result = Duration.INSTANCE.m1626getINFINITEUwyO8pc();
                } else {
                    ...
                    while (index < length) {
                        ...
                        if (dotIndex2 > 0) {
                            ...
                            String str6 = str;
                            long result4 = Duration.m1561plusLRDsOJo(result3, toDuration(Long.parseLong(whole2), unit2));
                            Intrinsics.checkNotNull(component2, "null cannot be cast to non-null type java.lang.String");
                            String strSubstring2 = component2.substring(dotIndex2);
                            Intrinsics.checkNotNullExpressionValue(strSubstring2, "this as java.lang.String).substring(startIndex)");
                            result3 = Duration.m1561plusLRDsOJo(result4, toDuration(Double.parseDouble(strSubstring2), unit2));
                            if (index < length) {
                                throw new IllegalArgumentException("Fractional component must be last");
                            }
                            str = str6;
                        } else {
                            result3 = Duration.m1561plusLRDsOJo(result3, toDuration(Long.parseLong(component2), unit2));
                            str = str;
                        }
                    }
                    result = result3;
        ...
        return isNegative ? Duration.m1578unaryMinusUwyO8pc(result) : result;
    }
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1525constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1525constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1525constructorimpl((normalValue << 1) + ((long) unitDiscriminator));
    }
