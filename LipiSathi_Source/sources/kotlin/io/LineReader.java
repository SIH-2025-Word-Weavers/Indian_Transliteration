...
public final class LineReader {
    ...
    /* JADX WARN: Code duplicated, block: B:9:0x0022 A[Catch: all -> 0x00d2, TryCatch #0 {, blocks: (B:3:0x0001, B:6:0x0012, B:7:0x0018, B:11:0x0027, B:13:0x0035, B:22:0x004a, B:36:0x0081, B:38:0x0089, B:40:0x008d, B:42:0x0095, B:43:0x0097, B:48:0x00a6, B:51:0x00af, B:53:0x00c4, B:54:0x00c7, B:23:0x004f, B:26:0x005a, B:30:0x0061, B:32:0x0072, B:34:0x007a, B:57:0x00cc, B:9:0x0022), top: B:62:0x0001 }] */
    public final synchronized String readLine(InputStream inputStream, Charset charset) {
        ...
        if (nChars > 0) {
            char[] cArr = chars;
            if (cArr[nChars - 1] == '\n' && (nChars = nChars - 1) > 0 && cArr[nChars - 1] == '\r') {
                nChars--;
            }
        }
