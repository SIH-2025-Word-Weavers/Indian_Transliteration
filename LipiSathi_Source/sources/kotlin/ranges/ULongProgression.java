...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1408getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM374constructorimpl = ((int) ULong.m374constructorimpl(j ^ ULong.m374constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM374constructorimpl2 = (iM374constructorimpl + ((int) ULong.m374constructorimpl(j2 ^ ULong.m374constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM374constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sbAppend = sb.append((Object) ULong.m420toStringimpl(this.first)).append("..").append((Object) ULong.m420toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            sbAppend = sb.append((Object) ULong.m420toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m420toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1434fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
