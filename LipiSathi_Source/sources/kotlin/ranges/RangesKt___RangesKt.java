...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final int coerceIn(int $this$coerceIn, ClosedRange<Integer> range) {
        ...
        return $this$coerceIn > ((Number) range.getEndInclusive()).intValue() ? ((Number) range.getEndInclusive()).intValue() : $this$coerceIn;
    }
    ...
    public static final long coerceIn(long $this$coerceIn, ClosedRange<Long> range) {
        ...
        return $this$coerceIn > ((Number) range.getEndInclusive()).longValue() ? ((Number) range.getEndInclusive()).longValue() : $this$coerceIn;
    }
}
