...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            cellsRemaining = widthLimit / i2;
            int cellSizeRemaining = widthLimit % i2;
        ...
        while (i3 < itemsSize) {
            ...
            if (item2.requiresActionButton()) {
                ...
                int widthLimit2 = widthLimit - measuredWidth;
                ...
                if (item2.requestsActionButton()) {
                    ...
                    boolean isAction2 = (maxActions3 > 0 || inGroup) && widthLimit > 0 && (!actionMenuPresenter.mStrictWidthLimit || cellsRemaining > 0);
                    if (isAction2) {
                        ...
                        if (actionMenuPresenter.mStrictWidthLimit) {
                            isAction2 = (widthLimit >= 0) & isAction;
                        } else {
                            isAction2 = (widthLimit + firstActionWidth > 0) & isAction;
                        }
                    } else {
                        maxActions = maxActions3;
                    }
                    if (isAction2 && groupId2 != 0) {
                        ...
                        if (inGroup) {
                            ...
                            while (j < i3) {
                                ...
                                ArrayList<MenuItemImpl> visibleItems2 = visibleItems;
