...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i2 < childCount2) {
            ...
            if (child.getVisibility() == 8) {
                ...
                int widthUsed7 = Math.max(widthUsed2, widthPadding + child.getMeasuredWidth() + lp.leftMargin + lp.rightMargin);
                int widthUsed8 = child.getMeasuredHeight();
                int heightUsed6 = Math.max(heightUsed2, heightPadding + widthUsed8 + lp.topMargin + lp.bottomMargin);
                int heightUsed7 = child.getMeasuredState();
                int iCombineMeasuredStates2 = View.combineMeasuredStates(childState2, heightUsed7);
                childState3 = widthUsed7;
                heightUsed3 = heightUsed6;
        ...
        int widthUsed9 = childState3;
        int widthUsed10 = widthUsed4;
        int width = View.resolveSizeAndState(widthUsed9, widthMeasureSpec, (-16777216) & widthUsed10);
        int height = View.resolveSizeAndState(heightUsed3, heightMeasureSpec, widthUsed10 << 16);
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (type != 0 || child.getVisibility() != 8) {
                ...
                if (type != 2) {
                    ...
                    while (j < childCount) {
                        View checkChild2 = this.mDependencySortedChildren.get(j);
                        LayoutParams checkLp2 = (LayoutParams) checkChild2.getLayoutParams();
                        b = checkLp2.getBehavior();
                        if (b == null) {
                        }
                    }
                }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        boolean isBlockingInteractionBelow(CoordinatorLayout parent, View child) {
            ...
            Behavior behavior = this.mBehavior;
            if (behavior != null) {
                zBlocksInteractionBelow = behavior.blocksInteractionBelow(parent, child);
            } else {
