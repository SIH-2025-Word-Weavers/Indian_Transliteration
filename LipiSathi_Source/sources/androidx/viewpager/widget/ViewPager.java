            ...
            if (i < count) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (lp.isDecor) {
                        ...
                        int paddingLeft3 = childLeft2 + child.getMeasuredWidth();
                        int paddingTop2 = paddingTop;
                        int paddingTop3 = childTop + child.getMeasuredHeight();
                        child.layout(childLeft2, childTop, paddingLeft3, paddingTop3);
                        decorCount++;
                        ...
                        if (lp2.isDecor) {
                            ...
                            if (ii == null) {
                                ...
                                if (lp2.needsMeasure) {
                                    ...
                                    int heightSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft4, BasicMeasure.EXACTLY);
        ...
        switch (action & 255) {
            ...
            case 2:
                if (!this.mIsBeingDragged) {
                    ...
                    int activePointerIndex3 = ev.findPointerIndex(this.mActivePointerId);
                    float x5 = ev.getX(activePointerIndex3);
