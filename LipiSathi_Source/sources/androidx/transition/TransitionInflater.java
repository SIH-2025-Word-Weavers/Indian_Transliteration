...
public class TransitionInflater {
    ...
    public Transition inflateTransition(int resource) {
        ...
        try {
            try {
                Transition transitionCreateTransitionFromXml = createTransitionFromXml(parser, Xml.asAttributeSet(parser), null);
                parser.close();
    ...
    public TransitionManager inflateTransitionManager(int resource, ViewGroup sceneRoot) {
        ...
        try {
            try {
                TransitionManager transitionManagerCreateTransitionManagerFromXml = createTransitionManagerFromXml(parser, Xml.asAttributeSet(parser), sceneRoot);
                parser.close();
