        ...
        if (startValues != null && endValues != null) {
            ...
            if (startParent != null && endParent != null) {
                        ...
                        if (this.mResizeClip) {
                            ...
                            if (numChanges != 2) {
                                ...
                                if (startLeft != endLeft || startTop != endTop) {
                                    ...
                                    anim = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, topLeftPath2);
                                    z = true;
                                } else {
                                ...
                                anim = ObjectAnimatorUtils.ofPointF(view2, POSITION_PROPERTY, topLeftPath4);
                                view = view2;
                                z = true;
                            }
                        }
                ...
                if (startX != endX || startY != endY) {
                    ...
                    int i2 = iArr[0];
                    int i3 = iArr[1];
                    Path topLeftPath5 = pathMotion.getPath(startX - i2, startY - i3, endX - i2, endY - i3);
