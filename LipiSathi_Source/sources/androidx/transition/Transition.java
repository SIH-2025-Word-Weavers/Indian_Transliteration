...
public abstract class Transition implements Cloneable {
    ...
    protected void createAnimators(ViewGroup sceneRoot, TransitionValuesMaps startValues, TransitionValuesMaps endValues, ArrayList<TransitionValues> startValuesList, ArrayList<TransitionValues> endValuesList) {
        ...
        int i = 0;
        while (i < startValuesListCount) {
            TransitionValues start2 = startValuesList.get(i);
            TransitionValues end2 = endValuesList.get(i);
            ...
            if (start == null && end == null) {
                startValuesListCount = startValuesListCount;
                i = i;
            } else {
        ...
        if (startDelays.size() != 0) {
            for (int i2 = 0; i2 < startDelays.size(); i2++) {
                ...
                animator5.setStartDelay((((long) startDelays.valueAt(i2)) - minStartDelay2) + animator5.getStartDelay());
            }
        }
    }
