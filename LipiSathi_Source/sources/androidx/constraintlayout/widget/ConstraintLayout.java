...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        /* JADX WARN: Code duplicated, block: B:29:0x0082 A[PHI: r20
  0x0082: PHI (r20v8 'horizontalSpec' int) = (r20v6 'horizontalSpec' int), (r20v9 'horizontalSpec' int) binds: [B:28:0x0080, B:24:0x0079] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        public final void measure(ConstraintWidget widget, BasicMeasure.Measure measure) {
            ...
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintWidget$DimensionBehaviour[horizontalBehavior.ordinal()]) {
                case 1:
                    ...
                    break;
                case 2:
                    int horizontalSpec4 = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, widthPadding, -2);
                    didHorizontalWrap = true;
                    widget.wrapMeasure[2] = -2;
                    horizontalSpec3 = horizontalSpec4;
                    break;
                case 3:
                    int horizontalSpec5 = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, widget.getHorizontalMargin() + widthPadding, -1);
                    widget.wrapMeasure[2] = -1;
                    horizontalSpec3 = horizontalSpec5;
                    break;
                case 4:
                    int horizontalSpec6 = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, widthPadding, -2);
                    didHorizontalWrap = true;
                    ...
                    if (measure.useCurrentDimensions) {
                        if (!shouldDoWrap || widget.wrapMeasure[3] == 0) {
                            horizontalSpec = horizontalSpec6;
                        } else {
                            int i2 = widget.wrapMeasure[0];
                            horizontalSpec = horizontalSpec6;
                            int horizontalSpec7 = widget.getWidth();
                            if (i2 != horizontalSpec7) {
                                useCurrent = true;
                            }
                            if (shouldDoWrap || useCurrent) {
                                int horizontalSpec8 = View.MeasureSpec.makeMeasureSpec(widget.getWidth(), BasicMeasure.EXACTLY);
                                didHorizontalWrap = false;
                                horizontalSpec3 = horizontalSpec8;
                            }
                        }
                        ...
                        didHorizontalWrap = false;
                        horizontalSpec3 = horizontalSpec9;
                    } else {
                        horizontalSpec = horizontalSpec6;
                    }
                    horizontalSpec3 = horizontalSpec;
                    break;
            }
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintWidget$DimensionBehaviour[verticalBehavior.ordinal()]) {
                case 1:
                    verticalSpec2 = View.MeasureSpec.makeMeasureSpec(verticalDimension, BasicMeasure.EXACTLY);
                    widget.wrapMeasure[3] = verticalDimension;
                    break;
                case 2:
                    verticalSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, heightPadding, -2);
                    didVerticalWrap = true;
                    widget.wrapMeasure[3] = -2;
                    break;
                case 3:
                    verticalSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, widget.getVerticalMargin() + heightPadding, -1);
                ...
                case 4:
                    ...
                    if (measure.useCurrentDimensions) {
                        if (shouldDoWrap2 && widget.wrapMeasure[2] != 0) {
                            if (widget.wrapMeasure[1] != widget.getHeight()) {
                                useCurrent2 = true;
                            }
                            if (shouldDoWrap2 || useCurrent2) {
                                verticalSpec2 = View.MeasureSpec.makeMeasureSpec(widget.getHeight(), BasicMeasure.EXACTLY);
            ...
            if (!measure.useCurrentDimensions && horizontalMatchConstraints && widget.mMatchConstraintDefaultWidth == 0 && verticalMatchConstraints && widget.mMatchConstraintDefaultHeight == 0) {
                ...
                if ((child instanceof VirtualLayout) && (widget instanceof androidx.constraintlayout.solver.widgets.VirtualLayout)) {
                    ...
                    ((VirtualLayout) child).onMeasure(layout, horizontalSpec3, verticalSpec2);
                } else {
                ...
                if (w == width && h == height) {
                    ...
                    if (h == height) {
                        verticalSpec = verticalSpec2;
                    } else {
                        verticalSpec = View.MeasureSpec.makeMeasureSpec(height, i);
                    }
                    child.measure(horizontalSpec2, verticalSpec);
            ...
            measure.measuredNeedsSolverPass = (width2 == measure.horizontalDimension && height2 == measure.verticalDimension) ? false : true;
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (tag != null && (tag instanceof String)) {
                        ...
                        if (split.length == 4) {
                            ...
                            float ch2 = y;
                            canvas.drawLine(x, y, x + w, ch2, paint);
