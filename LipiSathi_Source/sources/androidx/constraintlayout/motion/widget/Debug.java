    ...
    public static void dumpPoc(Object obj) {
        ...
        for (Field declaredField : declaredFields) {
            try {
                ...
                if (declaredField.getName().startsWith("layout_constraint") && ((!(value instanceof Integer) || !value.toString().equals(PluginCall.CALLBACK_ID_DANGLING)) && ((!(value instanceof Integer) || !value.toString().equals("0")) && ((!(value instanceof Float) || !value.toString().equals("1.0")) && (!(value instanceof Float) || !value.toString().equals("0.5")))))) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            for (Field declaredField : declaredFields) {
                try {
                    ...
                    if (name.contains("To") && !value.toString().equals(PluginCall.CALLBACK_ID_DANGLING)) {
                        System.out.println(loc + "       " + declaredField.getName() + " " + value);
                    }
                } catch (IllegalAccessException e) {
                }
