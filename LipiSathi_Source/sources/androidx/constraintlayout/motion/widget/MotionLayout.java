...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    /* JADX WARN: Code duplicated, block: B:28:0x0092 A[LOOP:0: B:27:0x0090->B:28:0x0092, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:31:0x00ca A[LOOP:1: B:30:0x00c8->B:31:0x00ca, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:34:0x0102  */
    /* JADX WARN: Code duplicated, block: B:36:0x010b A[LOOP:2: B:35:0x0109->B:36:0x010b, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:39:0x0133 A[LOOP:3: B:38:0x0131->B:39:0x0133, LOOP_END] */
    ...
    public void transitionToState(int id, int screenWidth, int screenHeight) {
        ...
        if (motionScene == null || motionScene.mStateSet == null) {
            ...
            if (i2 != -1) {
                ...
                stagger = this.mScene.getStaggered();
                if (stagger != 0.0f) {
                    min = Float.MAX_VALUE;
                    max = -3.4028235E38f;
                    for (i5 = 0; i5 < n; i5++) {
        ...
        if (i2 != -1) {
            ...
            while (i3 < n) {
                ...
                this.mFrameArrayList.put(v2, new MotionController(v2));
            }
            this.mInTransition = true;
            this.mModel.initFrom(this.mLayoutWidget, null, this.mScene.getConstraintSet(id2));
            rebuildScene();
            ...
            if (stagger != 0.0f) {
                ...
                while (i5 < n) {
                    ...
                    float x3 = f3.getFinalX();
                    float y3 = f3.getFinalY();
                    min = Math.min(min, y3 + x3);
                    max = Math.max(max, y3 + x3);
                }
                i6 = 0;
                while (i6 < n) {
                    MotionController f4 = this.mFrameArrayList.get(getChildAt(i6));
                    float x4 = f4.getFinalX();
                    float y4 = f4.getFinalY();
                    f4.mStaggerScale = 1.0f / (1.0f - stagger);
                    f4.mStaggerOffset = stagger - ((((x4 + y4) - min) * stagger) / (max - min));
                    i6++;
                    layoutWidth = layoutWidth;
                }
            }
    ...
    void evaluate(boolean force) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (force || this.mTransitionGoalPosition != f))) {
            ...
            float p3 = this.mLastVelocity;
            if (Math.abs(p3) > EPSILON) {
                setState(TransitionState.MOVING);
            }
            if ((dir > 0.0f && position >= this.mTransitionGoalPosition) || (dir <= 0.0f && position <= this.mTransitionGoalPosition)) {
                position = this.mTransitionGoalPosition;
    ...
    private boolean handlesTouchEvent(float x, float y, View view, MotionEvent event) {
        ...
        if (event.getAction() == 0) {
            return this.mBoundsCheck.contains(event.getX(), event.getY()) && view.onTouchEvent(event);
        }
    ...
    public void fireTrigger(int triggerId, boolean positive, float progress) {
        ...
        ArrayList<TransitionListener> arrayList = this.mTransitionListeners;
        if (arrayList != null) {
            for (TransitionListener listeners : arrayList) {
    ...
    private void fireTransitionChange() {
        ...
        if ((this.mTransitionListener != null || ((arrayList = this.mTransitionListeners) != null && !arrayList.isEmpty())) && this.mListenerPosition != this.mTransitionPosition) {
            if (this.mListenerState != -1) {
                ...
                if (arrayList2 != null) {
                    for (TransitionListener listeners : arrayList2) {
            ...
            if (arrayList3 != null) {
                for (TransitionListener listeners2 : arrayList3) {
