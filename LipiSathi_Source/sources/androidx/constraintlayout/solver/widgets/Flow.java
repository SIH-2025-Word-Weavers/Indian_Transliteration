...
public class Flow extends VirtualLayout {
    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        int nbMatchConstraintsWidgets3 = 0;
        if (orientation == 0) {
            int width = 0;
            int i3 = 0;
            while (i3 < count) {
                ...
                if (widget.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    nbMatchConstraintsWidgets2 = nbMatchConstraintsWidgets3;
                } else {
                    nbMatchConstraintsWidgets2 = nbMatchConstraintsWidgets3 + 1;
                }
                if (width == max) {
                    list3 = list4;
                    list3 = list4;
                    list3 = list4;
                    if (list3.biggest != null) {
                        doWrap3 = true;
                    } else {
                        list3 = list4;
                        doWrap3 = false;
                    ...
                    list3 = list4;
                    if (this.mHorizontalGap + width + w > max) {
                        list3 = list4;
                        list3 = list4;
                        list3 = list4;
                        if (list3.biggest != null) {
                ...
                if (doWrap4) {
                    WidgetsList list5 = new WidgetsList(orientation, this.mLeft, this.mTop, this.mRight, this.mBottom, max);
                    list5.setStartIndex(i3);
                ...
                list3.add(widget);
                i3++;
                nbMatchConstraintsWidgets3 = nbMatchConstraintsWidgets2;
            }
            list3 = list4;
            list2 = list3;
        } else {
            ...
            while (i4 < count) {
                ...
                if (widget2.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    nbMatchConstraintsWidgets = nbMatchConstraintsWidgets3;
                } else {
                    nbMatchConstraintsWidgets = nbMatchConstraintsWidgets3 + 1;
                }
                if (height == max) {
                    list = list4;
                    list = list4;
                    list = list4;
                    if (list.biggest != null) {
                        doWrap = true;
                    } else {
                        list = list4;
                        doWrap = false;
                    ...
                    list = list4;
                    if (this.mVerticalGap + height + h > max) {
                        list = list4;
                        list = list4;
                        list = list4;
                        if (list.biggest != null) {
                ...
                if (!doWrap && i4 > 0 && (i = this.mMaxElementsWrap) > 0 && i4 % i == 0) {
                    doWrap2 = true;
                } else {
                    doWrap2 = doWrap;
                }
                ...
                list.add(widget2);
                i4++;
                nbMatchConstraintsWidgets3 = nbMatchConstraintsWidgets;
            }
            list = list4;
            list2 = list;
        }
        ...
        if (nbMatchConstraintsWidgets3 > 0 && needInternalMeasure) {
            int i5 = 0;
            while (i5 < listCount) {
                ...
                nbMatchConstraintsWidgets3 = nbMatchConstraintsWidgets3;
            }
        }
