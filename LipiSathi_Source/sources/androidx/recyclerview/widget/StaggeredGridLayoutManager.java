        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == r10) {
                if (layoutParams.mFullSpan) {
                    decoratedMeasurement2 = getMaxEnd(i5);
                } else {
                    decoratedMeasurement2 = span.getEndLine(i5);
                }
            ...
            int i7 = decoratedMeasurement;
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (z2) {
                    this.mLaidOutInvalidFullSpan = r10;
                } else {
                    if (layoutState.mLayoutDirection == r10) {
                        i4 = (areAllEndsEqual() ? 1 : 0) ^ r10;
                    } else {
                        i2 = (areAllStartsEqual() ? 1 : 0) ^ r10;
                    }
                    if (i3 != 0) {
                        i3 = i2;
            ...
            if (isLayoutRTL() && this.mOrientation == r10) {
                ...
                decoratedMeasurement3 = this.mSecondaryOrientation.getDecoratedMeasurement(next) + i8;
                decoratedMeasurement4 = i8;
            }
            if (this.mOrientation == r10) {
                layoutDecoratedWithMargins(next, decoratedMeasurement4, i6, decoratedMeasurement3, i7);
            } else {
                layoutDecoratedWithMargins(next, i6, decoratedMeasurement4, i7, decoratedMeasurement3);
            }
            if (layoutParams.mFullSpan) {
