...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public ViewModelProvider.Factory getDefaultViewModelProviderFactory() {
        ...
        if (this.mDefaultFactory == null) {
            ...
            for (Context appContext = requireContext().getApplicationContext(); appContext instanceof ContextWrapper; appContext = ((ContextWrapper) appContext).getBaseContext()) {
    ...
    void performCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, getViewModelStore(), new Runnable() { // from class: androidx.fragment.app.Fragment$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m49lambda$performCreateView$0$androidxfragmentappFragment();
            }
        });
    ...
    /* synthetic */ void m49lambda$performCreateView$0$androidxfragmentappFragment() {
