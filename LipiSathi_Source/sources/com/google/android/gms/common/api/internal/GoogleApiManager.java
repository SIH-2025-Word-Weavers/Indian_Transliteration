...
public class GoogleApiManager implements Handler.Callback {
    ...
    private long zae = DeviceOrientationRequest.OUTPUT_PERIOD_FAST;
    private long zaf = 120000;
    private long zag = DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM;
    ...
    /* JADX WARN: Instruction removed from duplicated block: B:66:0x01f5, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:68:0x0233, please report this as an issue */
    @Override // android.os.Handler.Callback
    public final boolean handleMessage(Message message) {
        zabq zabqVar = null;
        switch (message.what) {
            case 1:
                this.zag = true == ((Boolean) message.obj).booleanValue() ? DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM : 300000L;
            ...
            case 9:
                ...
                return true;
            case 10:
                Iterator it = this.zas.iterator();
                while (it.hasNext()) {
                    zabq zabqVar5 = (zabq) this.zap.remove((ApiKey) it.next());
                    if (zabqVar5 != null) {
                        zabqVar5.zav();
                    }
                }
