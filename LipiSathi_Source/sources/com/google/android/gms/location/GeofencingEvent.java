...
import com.google.android.gms.libs.identity.zzef;
        ...
        if (intent != null) {
            ...
            if (arrayList2 == null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    zzef zzefVarCreateFromParcel = zzef.CREATOR.createFromParcel(parcelObtain);
                    parcelObtain.recycle();
                    arrayList.add(zzefVarCreateFromParcel);
                }
            }
