...
public final class CollapsingTextHelper {
    ...
    private float getCollapsedTextRightBound(RectF bounds, int width, int gravity) {
        ...
        if ((gravity & GravityCompat.END) == 8388613 || (gravity & 5) == 5) {
            return this.isRtl ? bounds.left + this.collapsedTextWidth : this.collapsedBounds.right;
        }
        return this.isRtl ? this.collapsedBounds.right : bounds.left + this.collapsedTextWidth;
    }
