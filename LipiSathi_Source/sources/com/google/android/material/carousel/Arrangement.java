...
final class Arrangement {
    ...
    private void fit(float availableSpace, float minSmallSize, float maxSmallSize, float targetLargeSize) {
        ...
        float fCalculateLargeSize = calculateLargeSize(availableSpace, this.smallCount, this.smallSize, this.mediumCount, this.largeCount);
        this.largeSize = fCalculateLargeSize;
        float f3 = (this.smallSize + fCalculateLargeSize) / 2.0f;
        this.mediumSize = f3;
        int i2 = this.mediumCount;
        if (i2 > 0 && fCalculateLargeSize != targetLargeSize) {
