...
final class MaterialCalendarGridView extends GridView {
    ...
    protected final void onDraw(Canvas canvas) {
        ...
        int firstVisiblePositionInMonth = Math.max(monthAdapter.firstPositionInMonth(), getFirstVisiblePosition());
                ...
                if (!skipMonth(firstOfMonth, lastOfMonth, Long.valueOf(startItem), Long.valueOf(endItem))) {
                    ...
                    while (row <= lastRow) {
                        ...
                        if (!isRtl) {
                            ...
                            width = rangeHighlightStart2 > lastPositionInRow ? getWidth() : rangeHighlightEnd;
                        } else {
                            left = rangeHighlightStart2 > lastPositionInRow ? 0 : rangeHighlightEnd;
