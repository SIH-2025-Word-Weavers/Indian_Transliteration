...
public class BridgeFragment extends Fragment {
    ...
    protected void load(Bundle savedInstanceState) throws XmlPullParserException, IOException {
        ...
        Bridge bridgeCreate = new Bridge.Builder(this).setInstanceState(savedInstanceState).setPlugins(this.initialPlugins).setConfig(this.config).addWebViewListeners(this.webViewListeners).create();
        this.bridge = bridgeCreate;
        if (startDir != null) {
            bridgeCreate.setServerAssetPath(startDir);
        }
    ...
    @Override // androidx.fragment.app.Fragment
    public void onViewCreated(View view, Bundle savedInstanceState) throws XmlPullParserException, IOException {
