...
public class SystemWebViewClient extends WebViewClient {
    ...
    public SystemWebViewClient(final SystemWebViewEngine parentEngine) {
        ...
        assetLoaderBuilder.addPathHandler("/", new WebViewAssetLoader.PathHandler() { // from class: org.apache.cordova.engine.SystemWebViewClient$$ExternalSyntheticLambda0
            ...
            public final WebResourceResponse handle(String str) {
                return this.f$0.m1765lambda$new$0$orgapachecordovaengineSystemWebViewClient(parentEngine, str);
            }
        });
    ...
    /* synthetic */ WebResourceResponse m1765lambda$new$0$orgapachecordovaengineSystemWebViewClient(final SystemWebViewEngine parentEngine, String path) {
