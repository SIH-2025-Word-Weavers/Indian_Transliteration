...
public class CordovaActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) throws XmlPullParserException, IOException {
        ...
        if (savedInstanceState != null) {
            cordovaInterfaceImplMakeCordovaInterface.restoreInstanceState(savedInstanceState);
        }
    }
    ...
    public Object onMessage(String id, Object data) {
        if ("onReceivedError".equals(id)) {
            ...
            try {
                onReceivedError(d.getInt("errorCode"), d.getString("description"), d.getString(ImagesContract.URL));
                return null;
